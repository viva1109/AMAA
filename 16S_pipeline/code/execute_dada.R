...
###########################################################################
silvaTsetFile = "/usr/local/16S_pipeline/file/silva_nr_v132_train_set.fa.gz"
silvaAssFile = "/usr/local/16S_pipeline/file/silva_species_assignment_v132.fa.gz"

ezTsetFile = "/usr/local/16S_pipeline/file/mod_eztaxon_qiime_full.fasta.gz"
ezAssFile  = "/usr/local/16S_pipeline/file/mod_eztaxon_qiime_full.fasta.species.gz"
...
if(length(args) != 11) {
	quit()
	cat("Please check the parameters.")
}

# trimdir = "/home/examples/AMAAtoy/1.trimmed"
# forid = "_1";revid = "_2";sstep = 1; dbid="silva"
# alloutdir = "/home/examples/AMAAtoy/table_dada"
# ncore =2;fTL = 275;rTL = 250;fMaxEE = 3;rMaxEE = 5
...
if(sstep<2){
    executedada(trimdir=trimPath,outdir = alloutdir,fMaxEE=fMaxEE,rMaxEE =rMaxEE,fTL = fTL, rTL = rTL,ncore = ncore)
}
