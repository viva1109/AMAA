...
# dirname = "D:/PROJECT/Dongeubogam/tbc2/"
# ucfile = dirname+"all.derep.uc"
# fastafile = dirname+"all.derep.fasta"
# taxfile = dirname+"tax_ez/assign_taxonomy/all.derep_tax_assignments.txt"
...
def usage():
    print("make_otu_table.py -t <taxfile> -u <ucfile> -f <fastafile> -c <threads> -o <outdir>")
...
def main():
    ...
    ncore = 1
    try:
        opts, args = getopt.getopt(sys.argv[1:],"ht:u:f:c:o:")
