#!/home/psc/miniconda3/envs/qiime1/bin/python
...
from qiime.rarefaction2 import RarefactionMaker
#from qiime.rarefaction2 import RarefactionMaker
...
script_info['required_options'] = [
    ...
    make_option('-o', '--output_path',
                ...
                type='new_dirpath'),
    make_option('-r', '--rare_ranges',
                help="Rarefaction ranges",
                type='string'),
...
script_info['option_label'] = {'input_path': 'OTU table filepath',
                               ...
                               'rare_ranges': 'Rarefaction ranges',
...
#                             opts.step, opts.num_reps)
    ...
    maker = RarefactionMaker(opts.input_path, opts.rare_ranges, opts.num_reps)
